...
for (file in inputFilePaths) {
  ...
  QC_Sys_metric <- extract_metrics(QC_Sys_sim)
  H_SG_metric <- extract_metrics(H_SG_sim)
  FW_Seg_G_metric <- extract_metrics(SW_simulation)

  # Combine metrics into a single dataframe
  metrics <- data.frame(
    Simulation = c("FW-Sys_2C", "FW-ZZ_2C", "FW-Sys_G", "FW-ZZ_G", "FW-Seg_G", "QC-Sys_nadir", "QC-Sys", "H-SG"),
    Mean_estimated_Density = c(FW_Sys_2C_metric$mean_estimate_density, FW_ZZ_2C_metric$mean_estimate_density, FW_Sys_G_metric$mean_estimate_density, FW_ZZ_G_metric$mean_estimate_density, FW_Seg_G_metric$mean_estimate_density, QC_Sys_nadir_metric$mean_estimate_density, QC_Sys_metric$mean_estimate_density, H_SG_metric$mean_estimate_density),
    True_Density = c(FW_Sys_2C_metric$true_density, FW_ZZ_2C_metric$true_density, FW_Sys_G_metric$true_density, FW_ZZ_G_metric$true_density, FW_Seg_G_metric$true_density, QC_Sys_nadir_metric$true_density, QC_Sys_metric$true_density, H_SG_metric$true_density),
    Mean_relative_Estimate = c(FW_Sys_2C_metric$relative_mean_estimate, FW_ZZ_2C_metric$relative_mean_estimate, FW_Sys_G_metric$relative_mean_estimate, FW_ZZ_G_metric$relative_mean_estimate, FW_Seg_G_metric$relative_mean_estimate, QC_Sys_nadir_metric$relative_mean_estimate, QC_Sys_metric$relative_mean_estimate, H_SG_metric$relative_mean_estimate),
    Percent_Bias = c(FW_Sys_2C_metric$percent_bias, FW_ZZ_2C_metric$percent_bias, FW_Sys_G_metric$percent_bias, FW_ZZ_G_metric$percent_bias, FW_Seg_G_metric$percent_bias, QC_Sys_nadir_metric$percent_bias, QC_Sys_metric$percent_bias, H_SG_metric$percent_bias),
    RRMSE = c(FW_Sys_2C_metric$rrmse, FW_ZZ_2C_metric$rrmse, FW_Sys_G_metric$rrmse, FW_ZZ_G_metric$rrmse, FW_Seg_G_metric$rrmse, QC_Sys_nadir_metric$rrmse, QC_Sys_metric$rrmse, H_SG_metric$rrmse),
    CI_Coverage_Prob = c(FW_Sys_2C_metric$ci_coverage_prob, FW_ZZ_2C_metric$ci_coverage_prob, FW_Sys_G_metric$ci_coverage_prob, FW_ZZ_G_metric$ci_coverage_prob, FW_Seg_G_metric$ci_coverage_prob, QC_Sys_nadir_metric$ci_coverage_prob, QC_Sys_metric$ci_coverage_prob, H_SG_metric$ci_coverage_prob),
    Mean_SE = c(FW_Sys_2C_metric$mean_rse, FW_ZZ_2C_metric$mean_rse, FW_Sys_G_metric$mean_rse, FW_ZZ_G_metric$mean_rse, FW_Seg_G_metric$mean_rse, QC_Sys_nadir_metric$mean_rse, QC_Sys_metric$mean_rse, H_SG_metric$mean_rse),
    CV = c(FW_Sys_2C_metric$sd_of_means, FW_ZZ_2C_metric$sd_of_means, FW_Sys_G_metric$sd_of_means, FW_ZZ_G_metric$sd_of_means, FW_Seg_G_metric$sd_of_means, QC_Sys_nadir_metric$sd_of_means, QC_Sys_metric$sd_of_means, H_SG_metric$sd_of_means),
    Mean_ER = c(FW_Sys_2C_metric$mean_ER, FW_ZZ_2C_metric$mean_ER, FW_Sys_G_metric$mean_ER, FW_ZZ_G_metric$mean_ER, FW_Seg_G_metric$mean_ER, QC_Sys_nadir_metric$mean_ER, QC_Sys_metric$mean_ER, H_SG_metric$mean_ER),
    Mean_se_ER = c(FW_Sys_2C_metric$mean_se_ER, FW_ZZ_2C_metric$mean_se_ER, FW_Sys_G_metric$mean_se_ER, FW_ZZ_G_metric$mean_se_ER, FW_Seg_G_metric$mean_se_ER, QC_Sys_nadir_metric$mean_se_ER, QC_Sys_metric$mean_se_ER, H_SG_metric$mean_se_ER)
  )
